    ...
    val games: List<Item> =
        listOf(
            ...
            Item(
                ...
                image = "https://upload.wikimedia.org/wikipedia/en/4/4c/Quake1cover.jpg",
                rating = 5,
            ),
            Item(
                id = "33",
                ...
                image = "https://upload.wikimedia.org/wikipedia/en/6/61/Duke_Nukem_3D_Coverart.png",
                rating = 5,
            ),
            Item(
                id = "44",
                ...
                description =
                    "Wolfenstein 3D is a first-person shooter video game developed by id Software and " +
                        ...
                        "of guns.",
                image = "https://upload.wikimedia.org/wikipedia/en/0/05/Wolfenstein-3d.jpg",
                rating = 4,
            ),
        ),
) : Model {
